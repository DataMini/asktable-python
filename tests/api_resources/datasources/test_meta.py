...
from asktable.types import MetaModelOutput
...
class TestMeta:
    ...
    def test_method_list(self, client: Asktable) -> None:
        meta = client.datasources.meta.list(
            datasource_id="datasource_id",
        )
        assert_matches_type(MetaModelOutput, meta, path=["response"])
    ...
    def test_raw_response_list(self, client: Asktable) -> None:
        response = client.datasources.meta.with_raw_response.list(
            datasource_id="datasource_id",
        )
    ...
    def test_streaming_response_list(self, client: Asktable) -> None:
        with client.datasources.meta.with_streaming_response.list(
            datasource_id="datasource_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Asktable) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `datasource_id` but received ''"):
            client.datasources.meta.with_raw_response.list(
                datasource_id="",
            )
...
class TestAsyncMeta:
    ...
    async def test_method_list(self, async_client: AsyncAsktable) -> None:
        meta = await async_client.datasources.meta.list(
            datasource_id="datasource_id",
        )
        assert_matches_type(MetaModelOutput, meta, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncAsktable) -> None:
        response = await async_client.datasources.meta.with_raw_response.list(
            datasource_id="datasource_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncAsktable) -> None:
        async with async_client.datasources.meta.with_streaming_response.list(
            datasource_id="datasource_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncAsktable) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `datasource_id` but received ''"):
            await async_client.datasources.meta.with_raw_response.list(
                datasource_id="",
            )
