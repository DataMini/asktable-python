...
from asktable.types.shared import PolicyOut
...
class TestPolicies:
    ...
    def test_method_create(self, client: Asktable) -> None:
        policy = client.auth.policies.create(
            dataset_config={"datasource_ids": ["string", "string", "string"]},
            name="name",
            permission="allow",
        )
        assert_matches_type(PolicyOut, policy, path=["response"])
    ...
    def test_raw_response_create(self, client: Asktable) -> None:
        response = client.auth.policies.with_raw_response.create(
            dataset_config={"datasource_ids": ["string", "string", "string"]},
            name="name",
            permission="allow",
        )
    ...
    def test_streaming_response_create(self, client: Asktable) -> None:
        with client.auth.policies.with_streaming_response.create(
            dataset_config={"datasource_ids": ["string", "string", "string"]},
            name="name",
            permission="allow",
        ) as response:
    ...
    def test_method_retrieve(self, client: Asktable) -> None:
        policy = client.auth.policies.retrieve(
            "policy_id",
        )
        assert_matches_type(PolicyOut, policy, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: Asktable) -> None:
        response = client.auth.policies.with_raw_response.retrieve(
            "policy_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Asktable) -> None:
        with client.auth.policies.with_streaming_response.retrieve(
            "policy_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Asktable) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `policy_id` but received ''"):
            client.auth.policies.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_update(self, client: Asktable) -> None:
        policy = client.auth.policies.update(
            policy_id="policy_id",
        )
        assert_matches_type(PolicyOut, policy, path=["response"])
    ...
    def test_raw_response_update(self, client: Asktable) -> None:
        response = client.auth.policies.with_raw_response.update(
            policy_id="policy_id",
        )
    ...
    def test_streaming_response_update(self, client: Asktable) -> None:
        with client.auth.policies.with_streaming_response.update(
            policy_id="policy_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: Asktable) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `policy_id` but received ''"):
            client.auth.policies.with_raw_response.update(
                policy_id="",
            )

    @parametrize
    def test_method_list(self, client: Asktable) -> None:
        policy = client.auth.policies.list()
        assert_matches_type(PagePolicyOut, policy, path=["response"])
    ...
    def test_raw_response_list(self, client: Asktable) -> None:
        response = client.auth.policies.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Asktable) -> None:
        with client.auth.policies.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Asktable) -> None:
        policy = client.auth.policies.delete(
            "policy_id",
        )
    ...
    def test_raw_response_delete(self, client: Asktable) -> None:
        response = client.auth.policies.with_raw_response.delete(
            "policy_id",
        )
    ...
    def test_streaming_response_delete(self, client: Asktable) -> None:
        with client.auth.policies.with_streaming_response.delete(
            "policy_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Asktable) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `policy_id` but received ''"):
            client.auth.policies.with_raw_response.delete(
                "",
            )
...
class TestAsyncPolicies:
    ...
    async def test_method_create(self, async_client: AsyncAsktable) -> None:
        policy = await async_client.auth.policies.create(
            dataset_config={"datasource_ids": ["string", "string", "string"]},
            name="name",
            permission="allow",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncAsktable) -> None:
        response = await async_client.auth.policies.with_raw_response.create(
            dataset_config={"datasource_ids": ["string", "string", "string"]},
            name="name",
            permission="allow",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncAsktable) -> None:
        async with async_client.auth.policies.with_streaming_response.create(
            dataset_config={"datasource_ids": ["string", "string", "string"]},
            name="name",
            permission="allow",
        ) as response:
    ...
    async def test_method_retrieve(self, async_client: AsyncAsktable) -> None:
        policy = await async_client.auth.policies.retrieve(
            "policy_id",
        )
        assert_matches_type(PolicyOut, policy, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncAsktable) -> None:
        response = await async_client.auth.policies.with_raw_response.retrieve(
            "policy_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncAsktable) -> None:
        async with async_client.auth.policies.with_streaming_response.retrieve(
            "policy_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncAsktable) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `policy_id` but received ''"):
            await async_client.auth.policies.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_update(self, async_client: AsyncAsktable) -> None:
        policy = await async_client.auth.policies.update(
            policy_id="policy_id",
        )
        assert_matches_type(PolicyOut, policy, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncAsktable) -> None:
        response = await async_client.auth.policies.with_raw_response.update(
            policy_id="policy_id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncAsktable) -> None:
        async with async_client.auth.policies.with_streaming_response.update(
            policy_id="policy_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncAsktable) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `policy_id` but received ''"):
            await async_client.auth.policies.with_raw_response.update(
                policy_id="",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncAsktable) -> None:
        policy = await async_client.auth.policies.list()
        assert_matches_type(PagePolicyOut, policy, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncAsktable) -> None:
        response = await async_client.auth.policies.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncAsktable) -> None:
        async with async_client.auth.policies.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncAsktable) -> None:
        policy = await async_client.auth.policies.delete(
            "policy_id",
        )
        assert policy is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncAsktable) -> None:
        response = await async_client.auth.policies.with_raw_response.delete(
            "policy_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncAsktable) -> None:
        async with async_client.auth.policies.with_streaming_response.delete(
            "policy_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncAsktable) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `policy_id` but received ''"):
            await async_client.auth.policies.with_raw_response.delete(
                "",
            )
