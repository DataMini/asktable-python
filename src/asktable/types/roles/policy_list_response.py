...
__all__ = [
    ...
    "PolicyListResponseItemDatasetConfig",
    "PolicyListResponseItemDatasetConfigRegexPatterns",
]


class PolicyListResponseItemDatasetConfigRegexPatterns(BaseModel):
...
class PolicyListResponseItemDatasetConfig(BaseModel):
    ...
    regex_patterns: Optional[PolicyListResponseItemDatasetConfigRegexPatterns] = None
    """
...
class PolicyListResponseItem(BaseModel):
    ...
    dataset_config: PolicyListResponseItemDatasetConfig
...
PolicyListResponse: TypeAlias = List[PolicyListResponseItem]
