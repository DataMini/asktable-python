...
__all__ = ["PolicyListResponse", "Item", "ItemDatasetConfig", "ItemDatasetConfigRegexPatterns"]


class ItemDatasetConfigRegexPatterns(BaseModel):
...
class ItemDatasetConfig(BaseModel):
    ...
    regex_patterns: Optional[ItemDatasetConfigRegexPatterns] = None
    """
