...
- <code title="post /securetunnels">client.securetunnels.<a href="./src/asktable/resources/securetunnels/securetunnels.py">create</a>(\*\*<a href="src/asktable/types/securetunnel_create_params.py">params</a>) -> <a href="./src/asktable/types/securetunnel_create_response.py">SecuretunnelCreateResponse</a></code>
- <code title="get /securetunnels/{securetunnel_id}">client.securetunnels.<a href="./src/asktable/resources/securetunnels/securetunnels.py">retrieve</a>(securetunnel_id) -> <a href="./src/asktable/types/securetunnel_retrieve_response.py">SecuretunnelRetrieveResponse</a></code>
- <code title="patch /securetunnels/{securetunnel_id}">client.securetunnels.<a href="./src/asktable/resources/securetunnels/securetunnels.py">update</a>(securetunnel_id, \*\*<a href="src/asktable/types/securetunnel_update_params.py">params</a>) -> <a href="./src/asktable/types/securetunnel_update_response.py">SecuretunnelUpdateResponse</a></code>
...
```python
from asktable.types.securetunnels import LinkListResponse
```

Methods:

- <code title="get /securetunnels/{securetunnel_id}/links">client.securetunnels.links.<a href="./src/asktable/resources/securetunnels/links.py">list</a>(securetunnel_id, \*\*<a href="src/asktable/types/securetunnels/link_list_params.py">params</a>) -> <a href="./src/asktable/types/securetunnels/link_list_response.py">LinkListResponse</a></code>
...
- <code title="post /roles">client.roles.<a href="./src/asktable/resources/roles/roles.py">create</a>(\*\*<a href="src/asktable/types/role_create_params.py">params</a>) -> <a href="./src/asktable/types/role_create_response.py">RoleCreateResponse</a></code>
- <code title="get /roles/{role_id}">client.roles.<a href="./src/asktable/resources/roles/roles.py">retrieve</a>(role_id) -> <a href="./src/asktable/types/role_retrieve_response.py">RoleRetrieveResponse</a></code>
- <code title="patch /roles/{role_id}">client.roles.<a href="./src/asktable/resources/roles/roles.py">update</a>(role_id, \*\*<a href="src/asktable/types/role_update_params.py">params</a>) -> <a href="./src/asktable/types/role_update_response.py">RoleUpdateResponse</a></code>
...
- <code title="post /policies">client.policies.<a href="./src/asktable/resources/policies.py">create</a>(\*\*<a href="src/asktable/types/policy_create_params.py">params</a>) -> <a href="./src/asktable/types/policy_create_response.py">PolicyCreateResponse</a></code>
- <code title="get /policies/{policy_id}">client.policies.<a href="./src/asktable/resources/policies.py">retrieve</a>(policy_id) -> <a href="./src/asktable/types/policy_retrieve_response.py">PolicyRetrieveResponse</a></code>
- <code title="patch /policies/{policy_id}">client.policies.<a href="./src/asktable/resources/policies.py">update</a>(policy_id, \*\*<a href="src/asktable/types/policy_update_params.py">params</a>) -> <a href="./src/asktable/types/policy_update_response.py">PolicyUpdateResponse</a></code>
...
- <code title="post /chats/{chat_id}">client.chats.messages.<a href="./src/asktable/resources/chats/messages.py">create</a>(chat_id, \*\*<a href="src/asktable/types/chats/message_create_params.py">params</a>) -> <a href="./src/asktable/types/chats/message_create_response.py">MessageCreateResponse</a></code>
...
- <code title="post /datasources">client.datasources.<a href="./src/asktable/resources/datasources/datasources.py">create</a>(\*\*<a href="src/asktable/types/datasource_create_params.py">params</a>) -> <a href="./src/asktable/types/datasource_create_response.py">DatasourceCreateResponse</a></code>
...
- <code title="patch /datasources/{datasource_id}">client.datasources.<a href="./src/asktable/resources/datasources/datasources.py">update</a>(datasource_id, \*\*<a href="src/asktable/types/datasource_update_params.py">params</a>) -> <a href="./src/asktable/types/datasource_update_response.py">DatasourceUpdateResponse</a></code>
...
- <code title="post /datasources/file">client.datasources.<a href="./src/asktable/resources/datasources/datasources.py">create_from_file</a>(\*\*<a href="src/asktable/types/datasource_create_from_file_params.py">params</a>) -> <a href="./src/asktable/types/datasource_create_from_file_response.py">DatasourceCreateFromFileResponse</a></code>
...
- <code title="post /bots">client.bots.<a href="./src/asktable/resources/bots.py">create</a>(\*\*<a href="src/asktable/types/bot_create_params.py">params</a>) -> <a href="./src/asktable/types/bot_create_response.py">BotCreateResponse</a></code>
- <code title="get /bots/{bot_id}">client.bots.<a href="./src/asktable/resources/bots.py">retrieve</a>(bot_id) -> <a href="./src/asktable/types/bot_retrieve_response.py">BotRetrieveResponse</a></code>
- <code title="patch /bots/{bot_id}">client.bots.<a href="./src/asktable/resources/bots.py">update</a>(bot_id, \*\*<a href="src/asktable/types/bot_update_params.py">params</a>) -> <a href="./src/asktable/types/bot_update_response.py">BotUpdateResponse</a></code>
...
from asktable.types import (
    ...
    ExtapiListResponse,
    ExtapiDeleteResponse,
)
```

Methods:

- <code title="post /extapis">client.extapis.<a href="./src/asktable/resources/extapis/extapis.py">create</a>(\*\*<a href="src/asktable/types/extapi_create_params.py">params</a>) -> <a href="./src/asktable/types/extapi_create_response.py">ExtapiCreateResponse</a></code>
- <code title="get /extapis/{extapi_id}">client.extapis.<a href="./src/asktable/resources/extapis/extapis.py">retrieve</a>(extapi_id) -> <a href="./src/asktable/types/extapi_retrieve_response.py">ExtapiRetrieveResponse</a></code>
- <code title="post /extapis/{extapi_id}">client.extapis.<a href="./src/asktable/resources/extapis/extapis.py">update</a>(extapi_id, \*\*<a href="src/asktable/types/extapi_update_params.py">params</a>) -> <a href="./src/asktable/types/extapi_update_response.py">ExtapiUpdateResponse</a></code>
...
- <code title="post /extapis/{extapi_id}/routes">client.extapis.routes.<a href="./src/asktable/resources/extapis/routes.py">create</a>(\*, path_extapi_id, \*\*<a href="src/asktable/types/extapis/route_create_params.py">params</a>) -> <a href="./src/asktable/types/extapis/route_create_response.py">RouteCreateResponse</a></code>
- <code title="get /extapis/{extapi_id}/routes/{route_id}">client.extapis.routes.<a href="./src/asktable/resources/extapis/routes.py">retrieve</a>(route_id, \*, extapi_id) -> <a href="./src/asktable/types/extapis/route_retrieve_response.py">RouteRetrieveResponse</a></code>
- <code title="post /extapis/{extapi_id}/routes/{route_id}">client.extapis.routes.<a href="./src/asktable/resources/extapis/routes.py">update</a>(route_id, \*, extapi_id, \*\*<a href="src/asktable/types/extapis/route_update_params.py">params</a>) -> <a href="./src/asktable/types/extapis/route_update_response.py">RouteUpdateResponse</a></code>
...
```python
from asktable.types.single_turn import Q2aCreateResponse, Q2aListResponse
```

Methods:

- <code title="post /single-turn/q2a">client.single_turn.q2a.<a href="./src/asktable/resources/single_turn/q2a.py">create</a>(\*\*<a href="src/asktable/types/single_turn/q2a_create_params.py">params</a>) -> <a href="./src/asktable/types/single_turn/q2a_create_response.py">Q2aCreateResponse</a></code>
...
- <code title="post /integration/excel_csv_ask">client.integration.<a href="./src/asktable/resources/integration/integration.py">excel_csv_ask</a>(\*\*<a href="src/asktable/types/integration_excel_csv_ask_params.py">params</a>) -> <a href="./src/asktable/types/integration_excel_csv_ask_response.py">IntegrationExcelCsvAskResponse</a></code>
...
- <code title="post /integration/create_excel_ds">client.integration.excel_csv.<a href="./src/asktable/resources/integration/excel_csv.py">create</a>(\*\*<a href="src/asktable/types/integration/excel_csv_create_params.py">params</a>) -> <a href="./src/asktable/types/integration/excel_csv_create_response.py">ExcelCsvCreateResponse</a></code>
...
- <code title="post /sys/projects">client.sys.projects.<a href="./src/asktable/resources/sys/projects/projects.py">create</a>(\*\*<a href="src/asktable/types/sys/project_create_params.py">params</a>) -> <a href="./src/asktable/types/sys/project_create_response.py">ProjectCreateResponse</a></code>
- <code title="get /sys/projects/{project_id}">client.sys.projects.<a href="./src/asktable/resources/sys/projects/projects.py">retrieve</a>(project_id) -> <a href="./src/asktable/types/sys/project_retrieve_response.py">ProjectRetrieveResponse</a></code>
- <code title="patch /sys/projects/{project_id}">client.sys.projects.<a href="./src/asktable/resources/sys/projects/projects.py">update</a>(project_id, \*\*<a href="src/asktable/types/sys/project_update_params.py">params</a>) -> <a href="./src/asktable/types/sys/project_update_response.py">ProjectUpdateResponse</a></code>
